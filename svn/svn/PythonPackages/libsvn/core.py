...
def svn_ver_check_list2(*args):
  """
    svn_ver_check_list2(svn_version_t my_version, svn_version_checklist_t checklist, 
        svn_boolean_t comparator) -> svn_error_t
    """
...
class svn_version_ext_linked_lib_t:
    ...
    def __init__(self): 
        """__init__(self) -> svn_version_ext_linked_lib_t"""
...
def svn_version_ext_linked_libs(*args):
  """svn_version_ext_linked_libs(svn_version_extended_t ext_info) -> apr_array_header_t"""
...
class svn_version_ext_loaded_lib_t:
    ...
    def __init__(self): 
        """__init__(self) -> svn_version_ext_loaded_lib_t"""
...
def svn_version_ext_loaded_libs(*args):
  """svn_version_ext_loaded_libs(svn_version_extended_t ext_info) -> apr_array_header_t"""
...
class svn_prop_inherited_item_t:
    ...
    def __init__(self): 
        """__init__(self) -> svn_prop_inherited_item_t"""
...
def svn_property_kind2(*args):
  """svn_property_kind2(char prop_name)"""
...
def svn_opt_print_help4(*args):
  """
    svn_opt_print_help4(apr_getopt_t os, char pgm_name, svn_boolean_t print_version, 
        svn_boolean_t quiet, svn_boolean_t verbose, 
        char version_footer, char header, svn_opt_subcommand_desc2_t cmd_table, 
...
def svn_cmdline_init(*args):
  """svn_cmdline_init(char progname, FILE error_stream) -> int"""
  return _core.svn_cmdline_init(*args)

def svn_cmdline_create_auth_baton2(*args):
  """
    svn_cmdline_create_auth_baton2(svn_boolean_t non_interactive, char username, char password, 
        char config_dir, svn_boolean_t no_auth_cache, 
...
def svn_cmdline_create_auth_baton(*args):
  """
    svn_cmdline_create_auth_baton(svn_boolean_t non_interactive, char username, char password, 
        char config_dir, svn_boolean_t no_auth_cache, 
...
def svn_auth_forget_credentials(*args):
  """
    svn_auth_forget_credentials(svn_auth_baton_t auth_baton, char cred_kind, char realmstring, 
        apr_pool_t pool) -> svn_error_t
    """
...
def svn_config_read3(*args):
  """
    svn_config_read3(char file, svn_boolean_t must_exist, svn_boolean_t section_names_case_sensitive, 
...
def svn_config_read(*args):
  """svn_config_read(char file, svn_boolean_t must_exist, apr_pool_t result_pool) -> svn_error_t"""
  return _core.svn_config_read(*args)

def svn_config_parse(*args):
  """
    svn_config_parse(svn_stream_t stream, svn_boolean_t section_names_case_sensitive, 
        svn_boolean_t option_names_case_sensitive, 
        apr_pool_t result_pool) -> svn_error_t
    """
...
def svn_config_get_int64(*args):
  """svn_config_get_int64(svn_config_t cfg, char section, char option, apr_int64_t default_value) -> svn_error_t"""
  return _core.svn_config_get_int64(*args)

def svn_config_set_int64(*args):
  """svn_config_set_int64(svn_config_t cfg, char section, char option, apr_int64_t value)"""
...
def svn_config_get_tristate(*args):
  """
    svn_config_get_tristate(svn_config_t cfg, svn_tristate_t valuep, char section, 
        char option, char unknown_value, svn_tristate_t default_value) -> svn_error_t
    """
...
def svn_config_walk_auth_data(*args):
  """
    svn_config_walk_auth_data(char config_dir, svn_config_auth_walk_func_t walk_func, 
...
def svn_config_invoke_auth_walk_func(*args):
  """
    svn_config_invoke_auth_walk_func(svn_config_auth_walk_func_t _obj, void walk_baton, 
        char cred_kind, char realmstring, apr_hash_t hash, 
        apr_pool_t scratch_pool) -> svn_error_t
    """
...
def svn_utf_cstring_utf8_width(*args):
  """svn_utf_cstring_utf8_width(char cstr) -> int"""
...
def svn_dirent_canonicalize(*args):
  """svn_dirent_canonicalize(char dirent, apr_pool_t result_pool) -> char"""
  return _core.svn_dirent_canonicalize(*args)

def svn_relpath_canonicalize(*args):
  """svn_relpath_canonicalize(char relpath, apr_pool_t result_pool) -> char"""
  return _core.svn_relpath_canonicalize(*args)

def svn_uri_canonicalize(*args):
  """svn_uri_canonicalize(char uri, apr_pool_t result_pool) -> char"""
  return _core.svn_uri_canonicalize(*args)

def svn_dirent_is_canonical(*args):
  """svn_dirent_is_canonical(char dirent, apr_pool_t scratch_pool) -> svn_boolean_t"""
...
def svn_uri_is_canonical(*args):
  """svn_uri_is_canonical(char uri, apr_pool_t scratch_pool) -> svn_boolean_t"""
  return _core.svn_uri_is_canonical(*args)

def svn_dirent_get_longest_ancestor(*args):
  """svn_dirent_get_longest_ancestor(char dirent1, char dirent2, apr_pool_t result_pool) -> char"""
  return _core.svn_dirent_get_longest_ancestor(*args)

def svn_relpath_get_longest_ancestor(*args):
  """svn_relpath_get_longest_ancestor(char relpath1, char relpath2, apr_pool_t result_pool) -> char"""
  return _core.svn_relpath_get_longest_ancestor(*args)

def svn_uri_get_longest_ancestor(*args):
  """svn_uri_get_longest_ancestor(char uri1, char uri2, apr_pool_t result_pool) -> char"""
  return _core.svn_uri_get_longest_ancestor(*args)

def svn_dirent_get_absolute(*args):
  """svn_dirent_get_absolute(char relative, apr_pool_t result_pool) -> svn_error_t"""
  return _core.svn_dirent_get_absolute(*args)

def svn_dirent_is_child(*args):
  """svn_dirent_is_child(char parent_dirent, char child_dirent, apr_pool_t result_pool) -> char"""
...
def svn_uri_get_dirent_from_file_url(*args):
  """svn_uri_get_dirent_from_file_url(char url, apr_pool_t result_pool) -> svn_error_t"""
  return _core.svn_uri_get_dirent_from_file_url(*args)

def svn_uri_get_file_url_from_dirent(*args):
  """svn_uri_get_file_url_from_dirent(char dirent, apr_pool_t result_pool) -> svn_error_t"""
...
def svn_mergeinfo_diff2(*args):
  """
    svn_mergeinfo_diff2(svn_mergeinfo_t mergefrom, svn_mergeinfo_t mergeto, 
...
def svn_mergeinfo_merge2(*args):
  """
    svn_mergeinfo_merge2(svn_mergeinfo_t mergeinfo, svn_mergeinfo_t changes, 
...
def svn_rangelist_diff(*args):
  """
    svn_rangelist_diff(svn_rangelist_t _from, svn_rangelist_t to, svn_boolean_t consider_inheritance, 
        apr_pool_t pool) -> svn_error_t
    """
...
def svn_rangelist_merge2(*args):
  """
    svn_rangelist_merge2(svn_rangelist_t rangelist, svn_rangelist_t changes, 
        apr_pool_t result_pool, apr_pool_t scratch_pool) -> svn_error_t
    """
...
def svn_rangelist_remove(*args):
  """
    svn_rangelist_remove(svn_rangelist_t eraser, svn_rangelist_t whiteboard, 
        svn_boolean_t consider_inheritance, apr_pool_t pool) -> svn_error_t
    """
...
def svn_rangelist_intersect(*args):
  """
    svn_rangelist_intersect(svn_rangelist_t rangelist1, svn_rangelist_t rangelist2, 
        svn_boolean_t consider_inheritance, apr_pool_t pool) -> svn_error_t
    """
  return _core.svn_rangelist_intersect(*args)

def svn_rangelist_to_string(*args):
  """svn_rangelist_to_string(svn_rangelist_t rangelist, apr_pool_t pool) -> svn_error_t"""
  return _core.svn_rangelist_to_string(*args)

def svn_rangelist_inheritable2(*args):
  """
    svn_rangelist_inheritable2(svn_rangelist_t rangelist, svn_revnum_t start, svn_revnum_t end, 
...
def svn_rangelist_inheritable(*args):
  """
    svn_rangelist_inheritable(svn_rangelist_t rangelist, svn_revnum_t start, svn_revnum_t end, 
        apr_pool_t pool) -> svn_error_t
    """
...
def svn_rangelist_dup(*args):
  """svn_rangelist_dup(svn_rangelist_t rangelist, apr_pool_t pool) -> svn_rangelist_t"""
...
def svn_io_filesizes_three_different_p(*args):
  """svn_io_filesizes_three_different_p(char file1, char file2, char file3, apr_pool_t scratch_pool) -> svn_error_t"""
...
def svn_io_files_contents_three_same_p(*args):
  """svn_io_files_contents_three_same_p(char file1, char file2, char file3, apr_pool_t scratch_pool) -> svn_error_t"""
  return _core.svn_io_files_contents_three_same_p(*args)

def svn_io_file_create_bytes(*args):
  """svn_io_file_create_bytes(char file, void contents, apr_size_t length, apr_pool_t scratch_pool) -> svn_error_t"""
  return _core.svn_io_file_create_bytes(*args)

def svn_io_file_create_empty(*args):
  """svn_io_file_create_empty(char file, apr_pool_t scratch_pool) -> svn_error_t"""
  return _core.svn_io_file_create_empty(*args)

def svn_io_lock_open_file(*args):
  """
    svn_io_lock_open_file(apr_file_t lockfile_handle, svn_boolean_t exclusive, 
        svn_boolean_t nonblocking, apr_pool_t pool) -> svn_error_t
    """
...
def svn_stream_puts(*args):
  """svn_stream_puts(svn_stream_t stream, char str) -> svn_error_t"""
...
def svn_stream_lazyopen_create(*args):
  """
    svn_stream_lazyopen_create(svn_stream_lazyopen_func_t open_func, void open_baton, 
        svn_boolean_t open_on_close, apr_pool_t result_pool) -> svn_stream_t
    """
...
def svn_io_stat_dirent2(*args):
  """
    svn_io_stat_dirent2(char path, svn_boolean_t verify_truename, svn_boolean_t ignore_enoent, 
        apr_pool_t result_pool, apr_pool_t scratch_pool) -> svn_error_t
    """
...
def svn_io_start_cmd3(*args):
  """
    svn_io_start_cmd3(apr_proc_t cmd_proc, char path, char cmd, svn_boolean_t inherit, 
        svn_boolean_t infile_pipe, apr_file_t infile, 
        svn_boolean_t outfile_pipe, apr_file_t outfile, 
...
def svn_io_start_cmd2(*args):
  """
    svn_io_start_cmd2(apr_proc_t cmd_proc, char path, char cmd, svn_boolean_t inherit, 
        svn_boolean_t infile_pipe, apr_file_t infile, 
        svn_boolean_t outfile_pipe, apr_file_t outfile, 
        svn_boolean_t errfile_pipe, 
        apr_file_t errfile, apr_pool_t pool) -> svn_error_t
...
def svn_io_file_aligned_seek(*args):
  """
    svn_io_file_aligned_seek(apr_file_t file, apr_off_t block_size, apr_off_t buffer_start, 
        apr_off_t offset, apr_pool_t scratch_pool) -> svn_error_t
    """
...
def svn_io_write_atomic(*args):
  """
    svn_io_write_atomic(char final_path, void buf, apr_size_t nbytes, char copy_perms_path, 
        apr_pool_t scratch_pool) -> svn_error_t
    """
...
def svn_io_file_readline(*args):
  """
    svn_io_file_readline(apr_file_t file, apr_size_t max_len, apr_pool_t result_pool, 
        apr_pool_t scratch_pool) -> svn_error_t
    """
...
def svn_stream_invoke_lazyopen_func(*args):
  """
    svn_stream_invoke_lazyopen_func(svn_stream_lazyopen_func_t _obj, void baton, apr_pool_t result_pool, 
        apr_pool_t scratch_pool) -> svn_error_t
    """
...
def svn_checksum_to_cstring_display(*args):
  """svn_checksum_to_cstring_display(svn_checksum_t checksum, apr_pool_t pool) -> char"""
  return _core.svn_checksum_to_cstring_display(*args)

def svn_checksum_to_cstring(*args):
  """svn_checksum_to_cstring(svn_checksum_t checksum, apr_pool_t pool) -> char"""
  return _core.svn_checksum_to_cstring(*args)

def svn_checksum_serialize(*args):
  """svn_checksum_serialize(svn_checksum_t checksum, apr_pool_t result_pool, apr_pool_t scratch_pool) -> char"""
  return _core.svn_checksum_serialize(*args)

def svn_checksum_deserialize(*args):
  """svn_checksum_deserialize(char data, apr_pool_t result_pool, apr_pool_t scratch_pool) -> svn_error_t"""
  return _core.svn_checksum_deserialize(*args)

def svn_checksum_parse_hex(*args):
  """svn_checksum_parse_hex(svn_checksum_kind_t kind, char hex, apr_pool_t pool) -> svn_error_t"""
  return _core.svn_checksum_parse_hex(*args)

def svn_checksum(*args):
  """
    svn_checksum(svn_checksum_kind_t kind, void data, apr_size_t len, 
        apr_pool_t pool) -> svn_error_t
    """
...
def svn_checksum_update(*args):
  """svn_checksum_update(svn_checksum_ctx_t ctx, void data, apr_size_t len) -> svn_error_t"""
  return _core.svn_checksum_update(*args)

def svn_checksum_final(*args):
  """svn_checksum_final(svn_checksum_ctx_t ctx, apr_pool_t pool) -> svn_error_t"""
...
def svn_checksum_mismatch_err(*args):
  """
    svn_checksum_mismatch_err(svn_checksum_t expected, svn_checksum_t actual, apr_pool_t scratch_pool, 
        char fmt, v(...) *args) -> svn_error_t
    """
...
def svn_swig_rangelist_merge(*args):
  """
    svn_swig_rangelist_merge(svn_rangelist_t rangelist_inout, svn_rangelist_t changes, 
        apr_pool_t pool) -> svn_error_t
    """
